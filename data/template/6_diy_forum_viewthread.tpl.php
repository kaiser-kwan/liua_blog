...
0
|| checktplrefresh('./template/ahome_common/forum/viewthread.htm', './template/ahome_common/forum/viewthread_node.htm', 1614881939, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/ahome_common', 'forum/viewthread')
|| checktplrefresh('./template/ahome_common/forum/viewthread.htm', './template/default/forum/viewthread_fastpost.htm', 1614881939, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/ahome_common', 'forum/viewthread')
|| checktplrefresh('./template/ahome_common/forum/viewthread.htm', './template/default/forum/viewthread_node_body.htm', 1614881939, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/ahome_common', 'forum/viewthread')
|| checktplrefresh('./template/ahome_common/forum/viewthread.htm', './template/default/common/seditor.htm', 1614881939, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/ahome_common', 'forum/viewthread')
|| checktplrefresh('./template/ahome_common/forum/viewthread.htm', './template/default/forum/seccheck_post.htm', 1614881939, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/ahome_common', 'forum/viewthread')
|| checktplrefresh('./template/ahome_common/forum/viewthread.htm', './template/default/common/upload.htm', 1614881939, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/ahome_common', 'forum/viewthread')
|| checktplrefresh('./template/ahome_common/forum/viewthread.htm', './template/default/common/seccheck.htm', 1614881939, 'diy', './data/template/6_diy_forum_viewthread.tpl.php', './template/ahome_common', 'forum/viewthread')
...
<?php } } else { if(!$_G['forum_thread']['is_archived']) { ?><a id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><div class="postbtn">+ 发新帖</div></a><?php } } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_reply" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复"><div class="replybtn">回复</div></a>
<?php } ?>
...
<div class="p_pop blk bui card_gender_<?php echo $post['gender'];?>" id="userinfo<?php echo $post['pid'];?>" style="min-width:450px;display: none;<?php if($_G['setting']['authoronleft']) { ?>float:left;margin-top:-16px;<?php } ?>">
<div class="m z">
...
<a id="newspecialtmp" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> href="javascript:;" title="发新帖"><div class="postbtn">+ 发新帖</div></a>
<?php } if($allowpostreply && !$_G['forum_thread']['archiveid']) { ?>
<a id="post_replytmp" onclick="showWindow('reply', 'forum.php?mod=post&action=reply&fid=<?php echo $_G['fid'];?>&tid=<?php echo $_G['tid'];?>')" href="javascript:;" title="回复"><div class="replybtn">回复</div></a>
<?php } ?>
</div>
