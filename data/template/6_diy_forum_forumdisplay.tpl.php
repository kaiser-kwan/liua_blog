...
0
|| checktplrefresh('./template/ahome_common/forum/forumdisplay.htm', './template/default/forum/forumdisplay_leftside.htm', 1614769932, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/ahome_common', 'forum/forumdisplay')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay.htm', './template/default/forum/recommend.htm', 1614769932, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/ahome_common', 'forum/forumdisplay')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay.htm', './template/default/common/seccheck.htm', 1614769932, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/ahome_common', 'forum/forumdisplay')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay.htm', './template/ahome_common/forum/forumdisplay_list.htm', 1614769932, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/ahome_common', 'forum/forumdisplay')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay.htm', './template/default/forum/forumdisplay_sort.htm', 1614769932, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/ahome_common', 'forum/forumdisplay')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1614769932, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/ahome_common', 'forum/forumdisplay')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay.htm', './template/default/forum/search_sortoption.htm', 1614769932, 'diy', './data/template/6_diy_forum_forumdisplay.tpl.php', './template/ahome_common', 'forum/forumdisplay')
...
<?php if(!$_GET['archiveid']) { ?><a href="javascript:;" id="newspecial" onmouseover="$('newspecial').id = 'newspecialtmp';this.id = 'newspecial';showMenu({'ctrlid':this.id})"<?php if(!$_G['forum']['allowspecialonly'] && empty($_G['forum']['picstyle']) && !$_G['forum']['threadsorts']['required']) { ?> onclick="showWindow('newthread', 'forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>')"<?php } else { ?> onclick="location.href='forum.php?mod=post&action=newthread&fid=<?php echo $_G['fid'];?>';return false;"<?php } ?> title="发新帖"><div class="postbtn">+ 发新帖</div></a><?php } ?>
...
<td class="num" style="width:80px !important">回复/查看</td>
<td class="by">最后发表</td>
<?php } else { ?>
...
<th><span class="xst">公告: <?php if(empty($announcement['type'])) { ?><a href="forum.php?mod=announcement&amp;id=<?php echo $announcement['id'];?>#<?php echo $announcement['id'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } else { ?><a href="<?php echo $announcement['message'];?>" target="_blank"><?php echo $announcement['subject'];?></a><?php } ?></span></th>
<td class="by" style="width:170px !important;">
<div class="listavat"><?php echo avatar($thread['authorid'],'small');; ?></div>
...
<tbody id="separatorline" class="emptb"><tr><td class="icn"></td><?php if($_G['forum']['ismoderator'] && !$_GET['archiveid']) { ?><td class="o"></td><?php } ?><th></th><td class="by" style="width:170px !important;"></td><td class="num" style="width:80px !important"></td><td class="by"></td></tr></tbody>
...
<div class="listavat"><?php echo avatar(0,'small');; ?></div>										
...
<td class="num" style="width:80px;"><a href="forum.php?mod=viewthread&amp;tid=<?php echo $thread['tid'];?>&amp;extra=<?php echo $extra;?>" class="xi2"><?php echo $thread['allreplies'];?></a><em><?php if($thread['isgroup'] != 1) { ?><?php echo $thread['views'];?><?php } else { ?><?php echo $groupnames[$thread['tid']]['views'];?><?php } ?></em></td>
<td class="by">
