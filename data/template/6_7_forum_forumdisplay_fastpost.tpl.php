...
0
|| checktplrefresh('./template/ahome_common/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1614769932, '7', './data/template/6_7_forum_forumdisplay_fastpost.tpl.php', './template/ahome_common', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1614769932, '7', './data/template/6_7_forum_forumdisplay_fastpost.tpl.php', './template/ahome_common', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1614769932, '7', './data/template/6_7_forum_forumdisplay_fastpost.tpl.php', './template/ahome_common', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/ahome_common/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1614769932, '7', './data/template/6_7_forum_forumdisplay_fastpost.tpl.php', './template/ahome_common', 'forum/forumdisplay_fastpost')
;?>
...
<h2 style="margin-bottom:20px;font-size:16px;">快速发帖</h2>
<div class="pbt cl">
...
<span id="checklen">还可输入 <strong>80</strong> 个字符</span>
</div>
