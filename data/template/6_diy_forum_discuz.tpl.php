...
<?php if(empty($gid)) { ?>
<ul class="dataul"><?php $weekarray=array("&#x65E5;","&#x4E00;","&#x4E8C;","&#x4E09;","&#x56DB;","&#x4E94;","&#x516D;");?><li style="border-left:0px;"><p class="data"><?php echo date("n&#x6708;j&#x65E5;",$_G['timestamp']);; ?></p><p class="desc"><?php echo "&#x661F;&#x671F;".$weekarray[date("w",$_G['timestamp'])]; ?></p></li>
<li><p class="data"><?php echo $todayposts;?></p><p class="desc">今日</p></li>
<li><p class="data"><?php echo $postdata['0'];?></p><p class="desc">昨日</p></li>
<li><p class="data"><?php echo $posts;?></p><p class="desc">帖子</p></li>
<li><p class="data"><?php echo $_G['cache']['userstats']['totalmembers'];?></p><p class="desc">会员</p></li>
<li><p class="data"><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></p><p class="desc">欢迎新会员</p></li>
</ul>
<div class="y">
...
<p class="data"><img src="template/ahome_common/src/default/mypost.png" style="height:40px;"></p><p class="desc">我的帖子</p>
</a>
</li>
<a href="forum.php?mod=guide&amp;view=new">
<li><p class="data"><img src="template/ahome_common/src/default/newreply.png" style="height:40px;"></p><p class="desc">最新回复</p></li>
    </a>
</ul>				
</div>
<?php } ?>
